...
def submit_feedback(request):
    ...
    # Supports both QR links like ?facility_id=1 and normal form posts with facility
    facility_id = (
...
def thank_you(request):
    return render(request, "feedback/thank_you.html")from django.contrib import messages
from django.shortcuts import redirect, render
